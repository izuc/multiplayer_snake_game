...
public class Snake extends ArrayList<Point> implements Constants {
		...
		private Point nextPoint(SnakePlayer.Compass direction) {
		...
		public void incrementSize(SnakePlayer.Compass direction) {
		...
		public void move(SnakePlayer.Compass direction) {
